...
Seq_len = 100
Hidden_size = 1024
Joints_num = 43  # Update this based on the number of joints in Euler data
Condition_num = 5
Groundtruth_num = 5
...
def generate_seq(initial_seq_np, generate_frames_number, model, save_dance_folder):
    ...
    for b in range(batch):
        ...
        read_bvh.write_euler_traindata_to_bvh(save_dance_folder + "out" + "%02d" % b + ".bvh", out_seq)
...
read_weight_path = "../train_weight_aclstm_martial_euler/0020000.weight"
# read_weight_path="C:/00_Assignment/MAI645_ML_for_CV/project645/train_weight_aclstm_martial_euler/0020000.weight"
write_bvh_motion_folder = "../test_bvh_aclstm_martial_euler/"
# write_bvh_motion_folder = "C:/00_Assignment/MAI645_ML_for_CV/project645/test_bvh_aclstm_martial_euler/"
dances_folder = "../train_data_euler/martial/"
# dances_folder = "C:/00_Assignment/MAI645_ML_for_CV/project645/train_data_euler/martial/"
...
in_frame_size = Joints_num * 3 + 3  # Euler angles plus hip position
hidden_size = 1024
out_frame_size = Joints_num * 3 + 3  # Euler angles plus hip position
