...
read_weight_path = ""
write_weight_folder = "../train_weight_aclstm_martial_6D/"

write_bvh_motion_folder = "../train_tmp_bvh_aclstm_martial_6D/"
...
train(dances, dance_frame_rate, batch, 100, read_weight_path, write_weight_folder,
      write_bvh_motion_folder, in_frame, out_frame, hidden_size, total_iter=2001)
# train(dances, dance_frame_rate, batch, 100, read_weight_path, write_weight_folder,
