...
Seq_len = 100
Hidden_size = 1024
Joints_num = 43  # Update this based on the number of joints in 6D data
Condition_num = 5
Groundtruth_num = 5
In_frame_size = Joints_num * 6  # 6D representation
...
def generate_seq(initial_seq_np, generate_frames_number, model, save_dance_folder):
    initial_seq = torch.autograd.Variable(torch.FloatTensor(initial_seq_np.tolist()).cuda())
    ...
    for b in range(batch):
        ...
        read_bvh.write_6D_traindata_to_bvh(save_dance_folder + "out" + "%02d" % b + ".bvh", out_seq)
...
def test(dance_batch_np, frame_rate, batch, initial_seq_len, generate_frames_number, read_weight_path,
    ...
    for b in range(batch):
        ...
        start_id = random.randint(10,
                                  int(dance_len - initial_seq_len * speed - 10))  # the first and last several frames are sometimes noisy.
        sample_seq = []
...
read_weight_path = "../train_weight_aclstm_martial_6D/0020000.weight"
# read_weight_path="C:/00_Assignment/MAI645_ML_for_CV/project645/train_weight_aclstm_martial_6D/0020000.weight"
write_bvh_motion_folder = "../test_bvh_aclstm_martial_6D/"
# write_bvh_motion_folder = "C:/00_Assignment/MAI645_ML_for_CV/project645/test_bvh_aclstm_martial_6D/"
dances_folder = "../train_data_6D/martial/"
# dances_folder = "C:/00_Assignment/MAI645_ML_for_CV/project645/train_data_6D/martial/"
...
in_frame_size = Joints_num * 6  # 6D representation
hidden_size = 1024
out_frame_size = Joints_num * 6  # 6D representation
