...
Seq_len = 100
Hidden_size = 1024
Joints_num = 43  # Update this based on the number of joints in quaternion data
Condition_num = 5
Groundtruth_num = 5
In_frame_size = Joints_num * 4  # Quaternion representation
...
def generate_seq(initial_seq_np, generate_frames_number, model, save_dance_folder):
    ...
    for b in range(batch):
        ...
        read_bvh.write_quad_traindata_to_bvh(save_dance_folder + "out" + "%02d" % b + ".bvh", out_seq)
...
read_weight_path = "../train_weight_aclstm_martial_quad/0020000.weight"
write_bvh_motion_folder = "../test_bvh_aclstm_martial_quad/"
...
in_frame_size = Joints_num * 4  # Quaternion representation
hidden_size = 1024
out_frame_size = Joints_num * 4  # Quaternion representation
